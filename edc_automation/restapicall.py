    ...
    def createResource(jsonData, resourceName):
        ...
        try:       
            ...
            if response.status_code == 200: # OK
                ...
                print(f"Error: General internal server error [{resourceName}]. Check if the resource conflicts with another object or if the values in the JSON file are correct.")
                logging.error(f"General internal server error [{resourceName}]. Check if the resource conflicts with another object or if the values in the JSON file are correct.") # log
