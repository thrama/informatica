...
class RestAPICall:
    ...
    def getResJSON(resourceName):
        ...
        try:
            ...
            logging.info(
                f"[getResJSON] - RestAPI for the resource [{resourceName}] answer with status code [{response.status_code}]."
            )  # log
    ...
    def setResJSON(resourceName, jsonData):
        ...
        try:
            ...
            logging.info(
                f"[setResJSON] - RestAPI for the resource [{resourceName}] answer with status code [{response.status_code}]."
            )  # log
    ...
    def runResource(resourceName):
        ...
        try:
            ...
            logging.info(
                f"[runResource] - RestAPI for the resource [{resourceName}] answer with status code [{response.status_code}]."
            )  # log
    ...
    def getJobStatus(resourceName, jobId):
        ...
        try:
            ...
            logging.info(
                f"[getJobStatus] - RestAPI for the resource [{resourceName}] answer with status code [{response.status_code}]."
            )  # log
